...
import {PointLight, Sprite} from "awayjs-full/lib/scene";
import {PrimitiveTorusPrefab, PrimitivePlanePrefab, StaticLightPicker, DisplayObjectContainer} from "awayjs-full/lib/scene";
